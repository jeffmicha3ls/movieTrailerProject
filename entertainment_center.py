...
matrix = media.Movie(
    "The Matrix",
    """Science fiction film about a dystopian future where reality is simulated
    reality""",
...
book_eli = media.Movie(
    "The Book of Eli",
    """Post apocalyptic nomad is told to deliver a Bible to a safe west coast
    location""",
...
oblivion = media.Movie(
    "Oblivion",
    """Humanity drains the oceans for fusion energy after a war with
    extraterrestrials""",
...
the_island = media.Movie(
    "The Island",
    """An escape from dystopia sci-fi film where clones are harvested for the
    wealthy""",
...
last_samurai = media.Movie(
    "The Last Samurai",
    """United States Captain fights alongside Enomoto Takeaki in the
    Boshin War""",
...
fifth_element = media.Movie(
    "The Fifth Element",
    """Former special forces major working as taxi driver tries to find 4
    mystical stones""",
    "Bruce Willis, Gary Oldman",
    "https://goo.gl/crXBvX",
    "https://www.youtube.com/watch?v=fQ9RqgcR24g")

flight_phoenix = media.Movie(
    "Flight of the Phoenix",
    """Survivors of a plane crash in the desert build a new plane out of the
    old one""",
...
# Need to understand why 12 movies did not format correctly,
# but divisible by both col-md-6 and col-lg-4
